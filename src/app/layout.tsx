...
export const metadata: Metadata = {
  ...
  title: {
    default: '輝旅 島専科（KIRATABI SHIMASENKA）| 日本の離島432島を制覇しよう',
  ...
  openGraph: {
    title: '輝旅 島専科（KIRATABI SHIMASENKA）| 日本の離島432島を制覇しよう',
    description: '日本全国432の離島をGPSチェックインで制覇。守護精霊を集めて、旅の記録を彩ろう。',
    url: 'https://island.kira-tabi.com',
    siteName: '輝旅 島専科（KIRATABI SHIMASENKA）',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: '輝旅 島専科 - 日本の離島432島を制覇しよう' }],
    locale: 'ja_JP',
    type: 'website',
  },
  twitter: {
